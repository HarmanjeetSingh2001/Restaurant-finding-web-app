					...
					connection.query(query2, function (err3, menus, fields2) {
						if(err3) { console.log(err3); }
							...
							forEach(restaurant.menus, function (menu, index) {
								...
								var query4 = "SELECT r.*,DATE_FORMAT(r.Review_date,'%d/%m/%Y') AS niceDate, u.Fname  FROM review r, users u WHERE r.Restaurant_id = "+restaurant.Restaurant_id+" and r.User_id = u.User_id";
